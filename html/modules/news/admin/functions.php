...
function adminmenu($currentoption = 0, $breadcrumb = '')
{
	...
	echo "<td style=\"width: 60%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;\">
		<a class=\"nobutton\" href=\"".$pref_url."\">"
			._AD_NEWS_GENERALSET . "</a> |
		<a href=\"../index.php\">" . _AD_NEWS_GOTOMOD . "</a> |
		<a href=\"#\">" . _AD_NEWS_HELP . "</a>
		</td>";
	echo "<td style=\"width: 40%; font-size: 10px; text-align: right; color: #2F5376; padding: 0 6px; line-height: 18px;\"><b>" . $xoopsModule->name() . "  " . _AD_NEWS_MODULEADMIN . "</b> " . $breadcrumb . "</td>";
	echo "</tr></table>";
	echo "</div>";
	...
	if ($xoopsModule->getVar('version') != 144) {
		echo "<li id='" . $tblColors[7] . "'><a href=\"upgrade.php\"><span>" . _AD_NEWS_UPGRADE . "</span></a></li>\n";
	}
	echo "</ul></div>";
	echo "<br clear='all' />";
}
