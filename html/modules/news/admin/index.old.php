...
function newSubmissions()
{
    ...
    if ( count($storyarray)> 0) {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topnewsubicon' name='topnewsubicon' src='" . XOOPS_URL . "/modules/news/images/close12.gif' alt='' /></a>&nbsp;"._AD_NEWSUB."</h4>";
		echo "<div id='newsub'>";
		echo "<br />";
        echo "<div style='text-align: center;'><table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'><tr class='bg3'><td align='center'>" . _AD_TITLE . "</td><td align='center'>" . _AD_TOPIC . "</td><td align='center'>" . _AD_POSTED . "</td><td align='center'>" . _AD_POSTER . "</td><td align='center'>" . _AD_ACTION . "</td></tr>\n";
        $class='';
        foreach( $storyarray as $newstory )
        {
            ...
            echo "</td><td>" . $newstory->topic_title() . "</td><td align='center' class='nw'>" . formatTimestamp($newstory->created(),$dateformat) . "</td><td align='center'><a href='" . XOOPS_URL . "/userinfo.php?uid=" . $newstory->uid() . "'>" . $newstory->uname() . "</a></td><td align='right'><a href='".XOOPS_URL."/modules/news/admin/index.php?op=delete&amp;storyid=" . $newstory->storyid() . "'>" . _AD_DELETE . "</a></td></tr>\n";
        }
        echo "</table></div>";
...
function autoStories()
{
    ...
    if(count($storyarray) > 0)
    {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topautostories' name='topautostories' src='" . XOOPS_URL . "/modules/news/images/close12.gif' alt='' /></a>&nbsp;"._AD_AUTOARTICLES."</h4>";
		echo "<div id='autostories'>";
		echo "<br />";
        echo "<div style='text-align: center;'>\n";
        echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'><tr class='bg3'><td align='center'>" . _AD_STORYID . "</td><td align='center'>" . _AD_TITLE . "</td><td align='center'>" . _AD_TOPIC . "</td><td align='center'>" . _AD_POSTER . "</td><td align='center' class='nw'>" . _AD_PROGRAMMED . "</td><td align='center' class='nw'>" . _AD_EXPIRED . "</td><td align='center'>" . _AD_ACTION . "</td></tr>";
        foreach($storyarray as $autostory)
        {
        	...
        	echo "<td align='center'><b>" . $autostory -> storyid() . "</b>
        		...
        		</td><td align='center'><a href='" . XOOPS_URL . "/userinfo.php?uid=" . $autostory->uid() . "'>" . $autostory->uname() . "</a></td><td align='center' class='nw'>" . formatTimestamp($autostory->published(),$dateformat) . "</td><td align='center'>" . $expire . "</td><td align='center'><a href='".XOOPS_URL."/modules/news/submit.php?returnside=1&amp;op=edit&amp;storyid=" . $autostory->storyid() . "'>" . _AD_EDIT . "</a>-<a href='".XOOPS_URL."/modules/news/admin/index.php?op=delete&amp;storyid=" . $autostory->storyid() . "'>" . _AD_DELETE . "</a>";
            echo "</td></tr>\n";
        }
        echo "</table></div>";
        echo "<div align='right'>".$pagenav->renderNav().'</div><br />';
...
function lastStories()
{
	...
	echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='toplaststories' name='toplaststories' src='" . XOOPS_URL . "/modules/news/images/close12.gif' alt='' /></a>&nbsp;".sprintf(_AD_LAST10ARTS,getmoduleoption('storycountadmin'))."</h4>";
    ...
    $class='';
    echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'><tr class='bg3'><td align='center'>" . _AD_STORYID . "</td><td align='center'>" . _AD_TITLE . "</td><td align='center'>" . _AD_TOPIC . "</td><td align='center'>" . _AD_POSTER . "</td><td align='center' class='nw'>" . _AD_PUBLISHED . "</td><td align='center' class='nw'>" . _AD_HITS . "</td><td align='center'>" . _AD_ACTION . "</td></tr>";
    foreach( $storyarray as $eachstory )
    {
        ...
        echo "<td align='center'><b>" . $eachstory -> storyid() . "</b>
        	...
        	</td><td align='center'><a href='" . XOOPS_URL . "/userinfo.php?uid=" . $eachstory -> uid() . "'>" . $eachstory -> uname() . "</a></td><td align='center' class='nw'>" . $published . "</td><td align='center'>" . $eachstory -> counter() . "</td><td align='center'><a href='".XOOPS_URL."/modules/news/submit.php?returnside=1&amp;op=edit&amp;storyid=" . $eachstory -> storyid() . "'>" . _AD_EDIT . "</a>-<a href='".XOOPS_URL."/modules/news/admin/index.php?op=delete&amp;storyid=" . $eachstory -> storyid() . "'>" . _AD_DELETE . "</a>";
        echo "</td></tr>\n";
    }
    echo "</table><br />";
	echo "<div align='right'>".$pagenav->renderNav().'</div><br />';

    echo "<form action='index.php' method='get'>" . _AD_STORYID . " <input type='text' name='storyid' size='10' />
    	<select name='op'>
    		<option value='edit' selected='selected'>" . _AD_EDIT . "</option>
    		<option value='delete'>" . _AD_DELETE . "</option>
    	</select>
		<input type='hidden' name='returnside' value='1'>
    	<input type='submit' value='" . _AD_GO . "' />
    	</form>
	</div>";
    echo "</div><br />";
}
...
function expStories()
{
    ...
    if(count($storyarray) > 0) {
		...
		echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='topexpstories' name='topexpstories' src='" . XOOPS_URL . "/modules/news/images/close12.gif' alt='' /></a>&nbsp;"._AD_EXPARTS."</h4>";
		echo "<div id='expstories'>";
		echo "<br />";
    	echo "<div style='text-align: center;'>";
    	echo "<table width='100%' cellspacing='1' cellpadding='3' border='0' class='outer'><tr class='bg3'><td align='center'>" . _AD_STORYID . "</td><td align='center'>" . _AD_TITLE . "</td><td align='center'>" . _AD_TOPIC . "</td><td align='center'>" . _AD_POSTER . "</td><td align='center' class='nw'>" . _AD_CREATED . "</td><td align='center' class='nw'>" . _AD_EXPIRED . "</td><td align='center'>" . _AD_ACTION . "</td></tr>";
    	foreach( $storyarray as $eachstory )
    	{
    	...
    	echo "<form action='index.php' method='get'>
	    	" . _AD_STORYID . " <input type='text' name='storyid' size='10' />
    		<select name='op'>
	    		<option value='edit' selected='selected'>" . _AD_EDIT . "</option>
    			<option value='delete'>" . _AD_DELETE . "</option>
    		</select>
...
function PruneManager()
{
    ...
    adminmenu(3);
    echo "<br />";
	$sform = new XoopsThemeForm(_AD_NEWS_PRUNENEWS, "pruneform", XOOPS_URL.'/modules/news/admin/index.php', 'post');
	$sform->addElement(new XoopsFormTextDateSelect(_AD_NEWS_PRUNE_BEFORE, 'prune_date',15,time()), true);
	$onlyexpired=new xoopsFormCheckBox('', 'onlyexpired');
	$onlyexpired->addOption(1, _AD_NEWS_PRUNE_EXPIREDONLY);
	$sform->addElement($onlyexpired, false);
	$sform->addElement(new XoopsFormHidden('op', 'confirmbeforetoprune'), false);
	$topiclist=new XoopsFormSelect(_AD_NEWS_PRUNE_TOPICS, 'pruned_topics','',5,true);
	$topics_arr=array();
	$xt = new NewsTopic();
	...
	$topiclist->setDescription(_AD_NEWS_EXPORT_PRUNE_DSC);
...
function PruneNews()
{
	...
	if(intval($_POST['ok'])==1) {
		...
		xoops_cp_header();
		$count=$story->GetCountStoriesPublishedBefore($timestamp,$expired,$topiclist);
		$msg=sprintf(_AD_NEWS_PRUNE_DELETED,$count);
...
function Newsletter()
{
    ...
    adminmenu(5);
    echo "<br />";
	$sform = new XoopsThemeForm(_AD_NEWS_NEWSLETTER, "newsletterform", XOOPS_URL.'/modules/news/admin/index.php', 'post');
	$dates_tray = new XoopsFormElementTray(_AD_NEWS_NEWSLETTER_BETWEEN);
	$date1 = new XoopsFormTextDateSelect('', 'date1',15,time());
	$date2 = new XoopsFormTextDateSelect(_AD_NEWS_EXPORT_AND, 'date2',15,time());
	$dates_tray->addElement($date1);
	$dates_tray->addElement($date2);
	$sform->addElement($dates_tray);

	$topiclist=new XoopsFormSelect(_AD_NEWS_PRUNE_TOPICS, 'export_topics','',5,true);
	$topics_arr=array();
	$xt = new NewsTopic();
	$allTopics = $xt->getAllTopics(false);				// The webmaster can see everything
	$topic_tree = new XoopsObjectTree($allTopics, 'topic_id', 'topic_pid');
	...
	$sform->addElement(new XoopsFormRadioYN(_AD_NEWS_REMOVE_BR, 'removebr',1),false);
	$button_tray = new XoopsFormElementTray('' ,'');
	$submit_btn = new XoopsFormButton('', 'post', _SUBMIT, 'submit');
	$button_tray->addElement($submit_btn);
	$sform->addElement($button_tray);
...
function LaunchNewsletter()
{
	...
	if(count($exportedstories)) {
		$fp=fopen($newsfile,'w');
		if(!$fp) {
			redirect_header('index.php',4,sprintf(_AD_NEWS_EXPORT_ERROR,$newsfile));
		}
		...
		printf(_AD_NEWS_NEWSLETTER_READY,$newsfile,XOOPS_URL.'/modules/news/admin/index.php?op=deletefile&amp;type=newsletter');
	} else {
		printf(_AD_NEWS_NOTHING);
	}
}
...
function NewsExport()
{
    ...
    adminmenu(4);
    echo "<br />";
	$sform = new XoopsThemeForm(_AD_NEWS_EXPORT_NEWS, "exportform", XOOPS_URL.'/modules/news/admin/index.php', 'post');
	$dates_tray = new XoopsFormElementTray(_AD_NEWS_EXPORT_BETWEEN);
	$date1 = new XoopsFormTextDateSelect('', 'date1',15,time());
	$date2 = new XoopsFormTextDateSelect(_AD_NEWS_EXPORT_AND, 'date2',15,time());
	$dates_tray->addElement($date1);
	$dates_tray->addElement($date2);
	...
	$topiclist->setDescription(_AD_NEWS_EXPORT_PRUNE_DSC);
	$sform->addElement($topiclist,false);
	$sform->addElement(new XoopsFormRadioYN(_AD_NEWS_EXPORT_INCTOPICS, 'includetopics',0),false);
...
function LaunchExport()
{
	...
	if(count($exportedstories)) {
		...
		$fp=fopen($xmlfile,'w');
		if(!$fp) {
			redirect_header('index.php',4,sprintf(_AD_NEWS_EXPORT_ERROR,$xmlfile));
		}
		...
		printf(_AD_NEWS_EXPORT_READY,$xmlfile,XOOPS_URL.'/modules/news/admin/index.php?op=deletefile&amp;type=xml');
	} else {
		printf(_AD_NEWS_EXPORT_NOTHING);
	}
}
...
function topicsmanager()
{
    ...
    xoops_cp_header();
    adminmenu(0);
    $uploadfolder=sprintf(_AD_UPLOAD_WARNING,XOOPS_URL . "/modules/" . $xoopsModule->dirname().'/images/topics');
	...
	echo "<img onclick=\"toggle('toptable'); toggleIcon('toptableicon');\" id='toptopicsmanager' name='toptopicsmanager' src='" . XOOPS_URL . "/modules/news/images/close12.gif' alt='' /></a>&nbsp;"._AD_TOPICSMNGR . ' (' . $totaltopics . ')'."</h4>";
	...
	$sform->addElement( new XoopsFormLabel( _AD_NEWS_TOPIC_COLOR, $select_color) );
	// Sub menu ?
	$sform->addElement(new XoopsFormRadioYN(_AD_SUB_MENU, 'submenu', $submenu, _YES, _NO));
	$sform->addElement(new XoopsFormRadioYN(_AD_PUBLISH_FRONTPAGE, 'topic_frontpage', $topic_frontpage, _YES, _NO));
	// Unused for this moment... sorry
	//$sform->addElement(new XoopsFormText(_AD_NEWS_RSS_URL, 'topic_rssfeed', 50, 255, $topic_rssfeed), false);
	// ********** Picture
	$imgtray = new XoopsFormElementTray(_AD_TOPICIMG,'<br />');

	$imgpath=sprintf(_AD_IMGNAEXLOC, "modules/" . $xoopsModule -> dirname() . "/images/topics/" );
    ...
    $fileseltray->addElement(new XoopsFormFile(_AD_TOPIC_PICTURE , 'attachedfile', getmoduleoption('maxuploadsize')), false);
...
function modTopicS()
{
    ...
    if (intval($_POST['topic_pid']) == intval($_POST['topic_id'])) {
        redirect_header( 'index.php?op=topicsmanager', 2, _AD_ADD_TOPIC_ERROR1 );
    }
    $xt->setTopicPid(intval($_POST['topic_pid']));
    if (empty($_POST['topic_title'])) {
        redirect_header( "index.php?op=topicsmanager", 2, _AD_ERRORTOPICNAME );
    }
		...
		if(xoops_trim($fldname!='')) {
			...
			if ($uploader->fetchMedia($_POST['xoops_upload_file'][0])) {
				if ($uploader->upload()) {
					...
					echo _AD_UPLOAD_ERROR . ' ' . $uploader->getErrors();
				}
			} else {
    ...
    $xt->store();
    updateCache();
    redirect_header( 'index.php?op=topicsmanager', 1, _AD_DBUPDATED );
    exit();
}
        ...
        foreach( $topic_arr as $eachtopic ) {
            ...
            foreach( $story_arr as $eachstory ) {
                if (false != $eachstory->delete()) {
                    ...
                    xoops_notification_deletebystory($xoopsModule->getVar('mid'), 'story', $eachstory->storyid());
                }
            }
...
function addTopic()
{
    ...
    if (!$xt->topicExists($topicpid, $_POST['topic_title'])) {
        ...
        $notification_handler->triggerEvent( 'global', 0, 'new_topics', $tags);
        redirect_header('index.php?op=topicsmanager', 1, _AD_DBUPDATED);
    } else {
        redirect_header('index.php?op=topicsmanager', 2, _AD_ADD_TOPIC_ERROR);
    }
    exit();
}
...
function Stats()
{
	...
	echo "<div style='text-align: center;'><b>" . _AD_NEWS_STATS0 . "</b><br />\n";
	echo "<table border='1' width='100%'><tr class='bg3'><td align='center'>"._AD_TOPIC."</td><td align='center'>" . _MD_ARTICLES . "</td><td>" . _MD_VIEWS . "</td><td>" . _AD_UPLOAD_ATTACHFILE . "</td><td>" . _AD_EXPARTS ."</td><td>" ._AD_NEWS_STATS1 ."</td></tr>";
	...
	$class = ($class == 'even') ? 'odd' : 'even';
	printf("<tr class='".$class."'><td align='center'><b>%s</b></td><td align='right'><b>%u</b></td><td align='right'><b>%u</b></td><td align='right'><b>%u</b></td><td align='right'><b>%u</b></td><td>&nbsp;</td>\n",_AD_NEWS_STATS2,$totals[0],$totals[1],$totals[2],$totals[3]);
	echo "</table></div><br /><br /><br />";

	// Second part of the stats, everything about stories
	// a) Most readed articles
	$mostreadednews=$stats['mostreadednews'];
	echo "<div style='text-align: center;'><b>" . _AD_NEWS_STATS3 . "</b><br /><br />" . _AD_NEWS_STATS4 . "<br />\n";
	echo "<table border='1' width='100%'><tr class='bg3'><td align='center'>"._AD_TOPIC."</td><td align='center'>" . _AD_TITLE . "</td><td>" . _AD_POSTER . "</td><td>" . _MD_VIEWS . "</td></tr>\n";
	...
	echo '<br /><br />'._AD_NEWS_STATS6;
	echo "<table border='1' width='100%'><tr class='bg3'><td align='center'>"._AD_TOPIC."</td><td align='center'>" . _AD_TITLE . "</td><td>" . _AD_POSTER . "</td><td>" . _MD_RATING . "</td></tr>\n";
	...
	echo "<div style='text-align: center;'><b>" . _AD_NEWS_STATS10 . "</b><br /><br />" . _AD_NEWS_STATS7 . "<br />\n";
	echo "<table border='1' width='100%'><tr class='bg3'><td>"._AD_POSTER."</td><td>" . _MD_VIEWS . "</td></tr>\n";
	...
	echo '<br /><br />'._AD_NEWS_STATS8;
	echo "<table border='1' width='100%'><tr class='bg3'><td>"._AD_POSTER."</td><td>" . _MD_RATING . "</td></tr>\n";
	...
	echo '<br /><br />'._AD_NEWS_STATS9;
	echo "<table border='1' width='100%'><tr class='bg3'><td>"._AD_POSTER."</td><td>" . _AD_NEWS_STATS11 . "</td></tr>\n";
...
switch ($op)
{
	case "deletefile":
		...
		if($_GET['type']=='newsletter')	{
			$newsfile=XOOPS_ROOT_PATH.'/uploads/newsletter.txt';
			if(unlink($newsfile)) {
				redirect_header('index.php', 2, _AD_NEWS_DELETED_OK);
			} else {
				redirect_header('index.php', 2, _AD_NEWS_DELETED_PB);
			}
		} else {
			if($_GET['type']=='xml') {
				$xmlfile=XOOPS_ROOT_PATH.'/uploads/stories.xml';
    ...
    case "delete":
        ...
        if (!empty($_POST['ok'])) {
            if (empty($storyid)) {
                redirect_header( 'index.php?op=newarticle', 2, _AD_EMPTYNODELETE );
                exit();
            }
            ...
            xoops_notification_deletebystory($xoopsModule->getVar('mid'), 'story', $storyid);
            updateCache();
            redirect_header( 'index.php?op=newarticle', 1, _AD_DBUPDATED );
            exit();
        } else {
        	$story = new NewsStory($storyid);
            xoops_cp_header();
            echo "<h4>" . _AD_CONFIG . "</h4>";
            xoops_confirm(array('op' => 'delete', 'storyid' => $storyid, 'ok' => 1), 'index.php', _AD_RUSUREDEL .'<br />' . $story->title());
        }
        break;
