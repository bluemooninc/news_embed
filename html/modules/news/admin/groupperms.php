...
<table border=0>
	...
	<td>
		...
		<option value='1'".$selected[0].">"._AD_APPROVEFORM."</option>
		<option value='2'".$selected[1].">"._AD_SUBMITFORM."</option>
		<option value='3'".$selected[2].">"._AD_VIEWFORM."</option>
		</select>
	</td>
	<td>
...
foreach ($alltopics as $topic_id => $topic) {
    $permform->addStory($topic_id, $topic['title'], $topic['pid']);
}
